    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "
            <div class='card'>
                ...
                <a href='viewdetails.php?id={$row['id']}' style='margin-left: 10px; padding: 12px 28px; background: #3b3f8c; color: white; border: none; border-radius: 25px; text-decoration: none;'>View Details</a>
                </div>
            </div>
        ";
    }
