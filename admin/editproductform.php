...
$id = isset($_GET['id']) ? (int)$_GET['id'] : (isset($_GET['product_id']) ? (int)$_GET['product_id'] : 0);

if ($id <= 0) {
    die("No valid product id provided.");
}
                    ...
                    <div class="input-group">
                        <label>Product Image</label>
                            <div style="margin-bottom:10px;">
                                ...
                                <img src="../image/<?php echo htmlspecialchars($product['image']); ?>" alt="Current product image" style="max-width:150px;max-height:150px;border-radius:8px;border:1px solid #d1d5db;">
                            </div>
